...
// Adapted from beUI's MIT-licensed Action Swap component:
...
const TEXT_VARIANTS: Record<CoreAnimation, Variants> = {
  blur: {
    ...
    exit: { opacity: 0, scale: 0.94, filter: "blur(8px)", transition: BLUR_TRANSITION },
  },
  roll: {
    initial: { opacity: 0, y: "90%", filter: "blur(3px)" },
    animate: { opacity: 1, y: "0%", filter: "blur(0px)", transition: ROLL_TRANSITION },
    exit: { opacity: 0, y: "-90%", filter: "blur(3px)", transition: ROLL_EXIT_TRANSITION },
  },
};
...
const ICON_VARIANTS: Record<CoreAnimation, Variants> = {
  ...
  roll: {
    ...
    animate: { opacity: 1, y: 0, filter: "blur(0px)", transition: ROLL_TRANSITION },
    exit: { opacity: 0, y: -12, filter: "blur(3px)", transition: ROLL_EXIT_TRANSITION },
  },
};
