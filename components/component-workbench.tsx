...
const tabs = ["Preview", "Usage", "Code"] as const;
    ...
    <section className="workbench" id="preview" aria-label={`${component.title} examples`}>
      ...
      <div className="workbench-toolbar">
        ...
        <div className="workbench-actions">
          ...
          {tab === "Code" && <a className="tool-action" href={`/components/${component.slug}/source`} download={filename} aria-label="Download Swift source" title="Download Swift source"><Download /></a>}
        </div>
      </div>
