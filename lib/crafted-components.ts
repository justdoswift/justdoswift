...
export const craftedComponents: SwiftComponent[] = [
  {
    ...
    description: "轻点展开，滑动翻阅。让照片带一点纸张的温度。",
  ...
  },
  {
    ...
    description: "长按确认，松手取消。为重要操作留一点余地。",
  ...
  },
  {
    ...
    description: "从播放条到完整封面，保持同一段播放状态。",
  ...
  },
  {
    ...
    description: "发送、等待、完成。失败时保留内容，随时重试。",
